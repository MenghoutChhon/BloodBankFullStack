...
async function main() {
  ...
  const donors = await Donor.insertMany([
    { fullName: "Chhunly Sok", email: "chhunly.sok@gmail.com", password: "test", blood: "A+", phone: "093222111", unitsDonated: 3 },
    { fullName: "Sreymom Hun", email: "sreymom.hun@gmail.com", password: "test", blood: "O-", phone: "015334455", unitsDonated: 5 },
    { fullName: "Vuthy Chea", email: "vuthy.chea@gmail.com", password: "test", blood: "B+", phone: "069876543", unitsDonated: 2 }
  ]);
  ...
  await User.insertMany([
    { name: "Sopheap Chan", email: "admin.khmer@hospital.com", password: "admin", role: "admin" },
    { name: "Borey Heng", email: "staff.khmer@hospital.com", password: "staff", role: "staff" }
  ]);
